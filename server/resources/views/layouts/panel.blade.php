...
<head>
  ...
  <title>Admin Panel - TiliCare</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('panel/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('panel/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <span class="d-none d-lg-block">TiliCare</span>
      </a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{ asset('panel/img/messages-1.jpg') }}" alt="" class="rounded-circle">
                <div>
                  <h4>Saba</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{ asset('panel/img/messages-2.jpg') }}" alt="" class="rounded-circle">
                <div>
                  <h4>Niki</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{ asset('panel/img/messages-3.jpg') }}" alt="" class="rounded-circle">
                <div>
                  <h4>Bob</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
  ...
  <script src="{{ asset('panel/vendor/quill/quill.min.js') }}"></script>
